    ...
    <Layout>
      <section className="pt-32 pb-16 md:pt-40 md:pb-20">
        <div className="section-container text-center max-w-3xl mx-auto">
          <span className="pill-tag mb-6 inline-block">{t("classesPage.tag")}</span>
          <h1 className="text-editorial-xl text-foreground whitespace-pre-line">{t("classesPage.headline")}</h1>
          <p className="text-body-lg mt-6">{t("classesPage.body")}</p>
        </div>
      </section>
